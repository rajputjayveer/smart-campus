...
export default function ShopkeeperPanel({ user, showToast }) {
    ...
    return (
        <div className="max-w-6xl w-full mx-auto flex-1 min-h-0 flex flex-col overflow-hidden transition-all bg-transparent">
            {/* Fixed Navigation Tabs */}
            <div className="flex-shrink-0 flex flex-wrap gap-2 px-2 pt-2 pb-4 mb-2">
                <button
                    onClick={() => setActiveTab('orders')}
                    className={`px-6 py-2.5 font-semibold transition-all rounded-lg ${activeTab === 'orders'
                        ? 'bg-indigo-600 text-white shadow-md'
                        : 'bg-white/70 text-gray-700 hover:bg-white hover:shadow-sm border border-gray-200'
                        }`}
                >
                    Orders
                </button>
                <button
                    ...
                    className={`px-6 py-2.5 font-semibold transition-all rounded-lg ${activeTab === 'menu'
                        ? 'bg-indigo-600 text-white shadow-md'
                        : 'bg-white/70 text-gray-700 hover:bg-white hover:shadow-sm border border-gray-200'
                        }`}
                >
                ...
                <button
                    ...
                    className={`px-6 py-2.5 font-semibold transition-all rounded-lg ${activeTab === 'coupons'
                        ? 'bg-indigo-600 text-white shadow-md'
                        : 'bg-white/70 text-gray-700 hover:bg-white hover:shadow-sm border border-gray-200'
                        }`}
                >
